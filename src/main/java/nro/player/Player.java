...
&& this.ItemBody[5].template.id != 639 && this.ItemBody[5].template.id != 640 && this.ItemBody[5].template.id != 641)) {
    ...
    public short MapAvatarLv0ToPart(int id) {
        short idreturn = 0;
        if(id == 196 || id == 197) { idreturn = 103; }
        else if(id == 198) { idreturn = 103; }
        else if(id == 199) { idreturn = 104; }
        else if(id == 200) { idreturn = 105; }
        else if(id == 201) { idreturn = 106; }
        else if(id == 202) { idreturn = 107; }
        else if(id == 203) { idreturn = 108; }
        else if(id == 204) { idreturn = 109; }
        else if(id == 205) { idreturn = 110; }
        else if(id == 206) { idreturn = 112; }
        else if(id == 207) { idreturn = 111; }
        else if(id == 208) { idreturn = 113; }
        else if(id == 209) { idreturn = 0; }
        else if(id == 210) { idreturn = 0; }
        else if(id == 227) { idreturn = 127; }
        else if(id == 228) { idreturn = 128; }
        else if(id == 229) { idreturn = 126; }
        return idreturn;
    }
